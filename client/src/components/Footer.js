    ...
    return(
        <footer className = {styles.conteiner}>
            <div className = {styles.divAbout}>
                ...
                <p className = {styles.parrafo}>Este es mi proyecto indivudual desarrollado en 3 semanas para el bootcamp SoyHenry el cual consiste en una aplicacion mediante la cual se puede crear razas de perro y buscarlas mediante una API(TheDogApi), filtrarlas, ordenarlas y acceder a sus respectivos detalles.</p>
            </div>
